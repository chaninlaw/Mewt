...
_"Your mic buddy that listens when you talk."_

### Mascot

แมว Mewt — pixel-art mascot โทน neutral (ขาวนุ่ม/ดำนุ่ม) ที่หลับตอน mute และเปลี่ยนสถานะตามการพูด
...
- Pixel-art แมวโทน neutral (ขาวนุ่ม/ดำนุ่ม) ขนาด ~80pt ใน popover hero card, ~18pt ใน menu bar
